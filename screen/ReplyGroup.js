...
const ReplyGroup = () => {
  ...
  try {
    ...
    const commentRef = doc(FIRESTORE_DB, 'groupPost', DocName, 'posts', postId, 'comment', commentItem);
...
const formatPostTime = (timestamp) => {
  ...
  const savecomment = async () => {
    try {
      ...
      // Now, save the comment to the 'groupPost' collection
      const GroupRef = collection(db, 'groupPost', DocName, 'posts', postId, 'comment',commentItem,'reply');
    ...
    <MaterialCommunityIcons 
      ...
      />
        ...
        <View style={{flexDirection: 'row',
          ...
          <ReplyGroupData comments={comment} DocName={DocName}/>
          </View>
          </View>
          </View>
          )} 
